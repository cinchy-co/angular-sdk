...
| 15 or 16        | >=5.11.0       | 6.0.0        | ^18.10.0             | `npm install @cinchy-co/angular-sdk@latest --save` |
| >17             | >=5.11.0       | 6.0.0        | ^18.13.0 or ^20.9.0  | `npm install @cinchy-co/angular-sdk@latest --save` |
